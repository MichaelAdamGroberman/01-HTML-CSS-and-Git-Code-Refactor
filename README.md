...
# Assignment Details
```
Alternative descriptions tags were added to all images on the site in-order to help with accesibility. Certain lines of the html document were rearrearanged, so that the site code follows a logical structure. I added a div ID to help with a broken anchor link. I added comments to make the code easier to follow. 
